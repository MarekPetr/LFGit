...
# installed.
TCL_PREFIX='/data/data/com.lfgit/files/usr'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/data/data/com.lfgit/files/usr'
...
TCL_EXTRA_CFLAGS=' -march=armv7-a -mfpu=neon -mfloat-abi=softfp -mthumb -fstack-protector-strong -Oz -DBIONIC_IOCTL_NO_SIGNEDNESS_OVERLOAD -pipe -I/data/data/com.lfgit/files/usr/include'
...
TCL_LD_FLAGS='-L/data/data/com.lfgit/files/usr/lib -Wl,-rpath=/data/data/com.lfgit/files/usr/lib -march=armv7-a -Wl,--enable-new-dtags -Wl,--as-needed -Wl,-z,relro,-z,now -Wl,--export-dynamic '
...
TCL_RANLIB='arm-linux-androideabi-ranlib'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/data/data/com.lfgit/files/usr/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/data/data/com.lfgit/files/usr/include'
...
TCL_PACKAGE_PATH='/data/data/com.lfgit/files/usr/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/data/data/com.lfgit/files/usr/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/builder/.termux-build/tcl/build/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/data/data/com.lfgit/files/usr/lib/libtclstub8.6.a'
